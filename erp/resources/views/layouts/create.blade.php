    ...
    @else
        @for ($i = 0; $i < 5; $i ++)
                    <tr>
                        ...
                        <td><input type="text" class="stock_no_tax_price" name="billOfSaleDetail[{{ $i }}][no_tax_price]" value="" style="text-align:right;" size="10"></td>
                        <td><input type="text" class="stock_no_tax_amount" style="text-align:right;" size="10"></td>
                    </tr>
        @endfor
    @endif
            ...
            <div style="width:100%;">
                <p>
                    營業稅
                    <input type="radio" class="tax_rate_code"
