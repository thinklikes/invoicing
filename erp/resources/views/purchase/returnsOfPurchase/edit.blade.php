        ...
        <form action="{{ url("/returnsOfPurchase/".$returnOfPurchaseMaster['code']) }}" method="POST">
            ...
            <table id="master" width="100%">
                <tr>
                    ...
                    <td>進貨退回單號</td>
                    <td><input type="text" id="master_code" value="{{ $returnOfPurchaseMaster['code']}}" readonly=""></td>
                    <td>發票號碼</td>
                ...
                <tr>
                    <th>進貨退回單備註</th>
                    <td colspan="5">
                        <input type="text" name="returnOfPurchaseMaster[note]" value="{{ $returnOfPurchaseMaster['note'] }}" size="50">
                    </td>
                </tr>
               <tr>
                    <th>進貨退回倉庫</th>
