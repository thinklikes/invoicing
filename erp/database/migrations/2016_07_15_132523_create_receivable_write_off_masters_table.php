...
class CreateReceivableWriteOffMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('erp_receivable_write_off_master', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('erp_receivable_write_off_master');
    }
}
