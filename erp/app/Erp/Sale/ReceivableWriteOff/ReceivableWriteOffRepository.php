...
use ReceivableWriteOff\ReceivableWriteOffMaster as OrderMaster;
use ReceivableWriteOff\ReceivableWriteOffCredit as OrderCredit;
use ReceivableWriteOff\ReceivableWriteOffDebit as OrderDebit;

class ReceivableWriteOffRepository extends BasicRepository
{
     ...
     * @param App\Purchase\ReceivableWriteOffMaster $orderMaster 表頭資料表的model instance
     * @param App\Purchase\ReceivableWriteOffCredit $orderCredit 貸方項目資料表的model instance
     * @param App\Purchase\ReceivableWriteOffDebit  $orderDebit  借方項目資料表的model instance
     */
     ...
     * @return App\Purchase\ReceivableWriteOffMaster       回傳表頭資料集合
     */
