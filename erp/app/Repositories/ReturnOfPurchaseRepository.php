...
use App\ReturnOfPurchaseMaster;

use App\ReturnOfPurchaseDetail;

use DB;

use Schema;

class ReturnOfPurchaseRepository
{
    protected $orderMaster;
    protected $orderDetail;

    protected $orderMasterClassName = ReturnOfPurchaseMaster::class;
    protected $orderDetailClassName = ReturnOfPurchaseDetail::class;
    /**
     * ReturnOfPurchaseRepository constructor.
     *
     * @param ReturnOfPurchaseMaster $puchase_order_master
     */
    public function __construct(ReturnOfPurchaseMaster $orderMaster,
        ReturnOfPurchaseDetail $orderDetail)
    {
 ...
 */
     ...
     */
    public function getOrdersOnePage()
    {
        return $this->orderMaster->paginate(15);
    }
    ...
    public function storeOrderDetail($orderDetail, $code)
    {
        ...
        $this->orderDetail = new $this->ReturnOfPurchaseDetail;
    ...
    public function updateOrderDetail($orderDetail, $code)
    {
        ...
        $this->orderDetail = new ReturnOfPurchaseDetail;
