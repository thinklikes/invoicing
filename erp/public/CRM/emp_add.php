...
// *** Redirect if username exists
  $LoginRS__query = sprintf("SELECT employee_id FROM users order by id desc", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $num=explode("EMP",$employee_id);$num[1]++;
  $employee_id="EMP".str_pad($num[1],8,'0',STR_PAD_LEFT);
  $updateSQL = sprintf("insert into users (`name`, `emp_name`, `email`, `password`, `created_at`, `leavl`,`remark`,`employee_id`) values(%s,%s,%s,%s,%s,%s,%s,%s)",
