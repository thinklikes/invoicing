...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM das WHERE no=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $updateSQL = sprintf("update das set `c_id`=%s, `version`=%s, `contract_period`=%s, `contract_buy`=%s, `up_money`=%s, `up_remark`=%s, `server_address`=%s, `server_amount`=%s, `remark`=%s, `contract_YN`=%s, `declaration_no`=%s where no=%s",
 ...
 <h3>修改DAS資料</h3>
          ...
          <div class="panel-body">
                 ...
                 <select name="version" id="version" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					<option value="MySQL豪華版DAGL" <?php if($result["version"]=="MySQL豪華版DAGL")echo "selected"; ?>>MySQL豪華版DAGL</option>";
					<option value="PARADOX" <?php if($result["version"]=="PARADOX")echo "selected"; ?>>PARADOX</option>";
					<option value="MYSQL簡易版" <?php if($result["version"]=="MYSQL簡易版")echo "selected"; ?>>MYSQL簡易版</option>";
					<option value="MYSQL標準版" <?php if($result["version"]=="MYSQL標準版")echo "selected"; ?>>MYSQL標準版</option>";
				 </select>
                 </span><br>
										 </div>
                                    </div>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["contract_period"],0,3);
											$mm=substr($result["contract_period"],3,2);
											$dd=substr($result["contract_period"],5,2);
										 ?>
				 ...
				 <select name="dd1" id="dd1" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					?>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["contract_buy"],0,3);
											$mm=substr($result["contract_buy"],3,2);
											$dd=substr($result["contract_buy"],5,2);
										 ?>
                 ...
                 <input name="up_money" type="text" class="form-control" id="up_money" value="<?php echo $result["up_money"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <textarea name="up_remark" rows="3" cols="50" class="form-control" id="up_remark"><?php echo $result["up_remark"]; ?></textarea>
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="server_address" type="text" class="form-control" id="server_address" value="<?php echo $result["server_address"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="server_amount" type="text" class="form-control" id="server_amount" value="<?php echo $result["server_amount"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="contract_YN" type="checkbox" id="contract_YN" value="1" <?php if($result["contract_YN"]==1)echo "checked"; ?>>
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="declaration_no" type="text" class="form-control" id="declaration_no" value="<?php echo $result["declaration_no"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									...
									<div class="form-group">
                                         ...
                                         <div class="col-sm-10"><span id="sprytextfield6">
                 <textarea name="remark" rows="3" cols="50" class="form-control" id="remark"><?php echo $result["remark"]; ?></textarea>
                 </span><br>
										 </div>
                                    </div>
