...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $updateSQL = sprintf("insert into company_system (company_name,company_status , mailbox, company_abb, company_contact, company_con_tel, company_con_email, company_con_fax, company_tel, company_fax, company_add, VTA_NO,internet_phone,line,skype,wechat,company_remark) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
  ...
  $sql_cid=sprintf("select auto_id from company_system where VTA_NO=%s",GetSQLValueString($_POST['VTA_NO'], "text"));//把客戶狀態與客戶編號寫進cust_purchase
  $Result2 = mysqli_query($connSQL,$sql_cid) or die("修改資料錯誤".mysqli_error());
  $row=mysqli_fetch_array($Result2);
  $sql_insert=sprintf("insert into cust_purchase (c_id,company_status) values(%s,%s)",GetSQLValueString($row['auto_id'], "text"),
					   GetSQLValueString($_POST['company_status'], "text"));
   $Result3 = mysqli_query($connSQL,$sql_insert) or die("修改資料錯誤".mysqli_error());
...
<div id="wrapper">
 ...
 <h3>新增廠商資料</h3>
          ...
          <div class="panel-body">
                 ...
                 <input name="mailbox" type="text" class="form-control" id="mailbox" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="company_abb" type="text" class="form-control" id="company_abb" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="company_tel" type="text" class="form-control" id="company_tel" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="company_fax" type="text" class="form-control" id="company_fax" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="internet_phone" type="text" class="form-control" id="internet_phone" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="company_add" type="text" class="form-control" id="company_add" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="VTA_NO" type="text" class="form-control" id="VTA_NO">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="company_con_tel" type="text" class="form-control" id="company_con_tel" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="company_con_email" type="text" class="form-control" id="company_con_email" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="company_con_fax" type="text" class="form-control" id="company_con_fax" >
                 </span><br>
										 </div>
                                    </div>
				 ...
				 <option value="3">不使用</option></select>
                 </span><br>
										 </div>
                                    </div>
						...
						<div class="col-xs-4">
											<input type="text" name="line"  id="line" class="form-control" placeholder="Line帳號">
										  </div>
						<div class="col-xs-4">
											<input type="text" name="skype"  id="skype" class="form-control" placeholder="Skype帳號">
										  </div>
						<div class="col-xs-4">
											<input type="text" name="wechat"  id="wechat" class="form-control" placeholder="WeChat帳號">
										  </div>
										 </div>
                                    </div>
									...
									<div class="form-group">
                                         ...
                                         <div class="col-sm-10"><span id="sprytextfield14">
				<textarea name="company_remark" rows="4" cols="50" class="form-control" id="company_remark"></textarea>
                 </span><br>
										 </div>
                                    </div>
