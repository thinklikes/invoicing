...
<strong>
			 ...
			 <button type="button" class="btn btn-link" onclick="window.open('addressbook_add.php', 'newwindow', 'height=700, width=800');">新增通訊錄</button>
		   </form>
        </div><BR>
	    <div class="btn-group">
		<div class="container-fluid">
            <button type="button" class="btn btn-info" onclick="location.href='company_system.php';"> 客戶資料管理</button>
