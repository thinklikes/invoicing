...
if($_SESSION['MM_Username']!=""){
	...
	{
		$sql_de = "delete from cust_maintain where no = '".$_GET["deliid"]."'";
...
$query_RecMember = sprintf("SELECT * FROM cust_maintain WHERE   %s LIKE %s ORDER BY no", $colname_RecMember,GetSQLValueString($keyword_RecMember, "text"));
...
<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="customers_maintain_system.php"><?php echo $sys_name; ?></a>
            </div>
            <!-- Top Menu Items -->
        ...
        <div id="page-wrapper">
         ...
         <div class="search">
           <form name="form1" method="get" action="customers_maintain_system.php"  class="form-inline" >
<strong>
  ...
  <?php $i=1; do {  $auto_id=$row_RecMember['no'];?>
	  ...
	  <tr class="td_row" style="background-color:#CCEEFF">
		<?php
			...
			<td data-th="合約台數"><?php echo $row_RecMember['contract_amount'];?></td>
			<td data-th="實際台數"><?php echo $row_RecMember['actual_amount'];?></td>
			<td data-th="新客戶到期"><?php echo $row_RecMember['newcust_end'];?></td>
      ...
      <tr class="td_row" style="background-color:#CCEEFF">
			<td data-th="維護費用"><?php echo $row_RecMember['cost'];?></td>
			<td data-th="送合約日期"><?php echo $row_RecMember['send_contract'];?></td>
			<td data-th="已簽約"><?php echo $row_RecMember['contract'];?></td>
			<td data-th="已收款"><?php echo $row_RecMember['invoice'];?></td>
			<td data-th="已收發票"><?php echo $row_RecMember['charge'];?></td>
