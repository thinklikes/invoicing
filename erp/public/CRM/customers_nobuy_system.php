  ...
  <?php $i=1; do {  $auto_id=$row_RecMember['no'];?>
	  ...
	  <tr class="td_row" style="background-color:#CCEEFF">
			...
			<td data-th="功能" colspan="2">
				...
				<input type="button" value="購買" class="btn btn-success" onclick="if(confirm('客戶是否要購買?'))location.href='customers_nobuy_system.php?upid=<?php echo $auto_id;?>&c_id=<?php echo $row_RecMember['c_id'];?>';">
				<input type="button" value="租用" class="btn btn-warning" onclick="if(confirm('客戶是否要租用?'))location.href='customers_nobuy_system.php?upid2=<?php echo $auto_id;?>&c_id=<?php echo $row_RecMember['c_id'];?>';">
