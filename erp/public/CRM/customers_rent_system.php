...
if($_SESSION['MM_Username']!=""){
	...
	if(isset($_GET["upid"]))
	{
		...
		$sql_up2="update company_system set company_status='1' where auto_id='".$_GET["c_id"]."'";
...
$query_RecMember = sprintf("SELECT * FROM cust_purchase WHERE  company_status='2' and %s LIKE %s ORDER BY no", $colname_RecMember,GetSQLValueString($keyword_RecMember, "text"));
...
<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="customers_rent_system.php"><?php echo $sys_name; ?></a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="container-fluid">
                 ...
                 <div class="row">
                    <div class="col-md-12">
                          ...
                          <h3>租用客戶資料管理</h3>
         <div class="search">
           <form name="form1" method="get" action="customers_rent_system.php"  class="form-inline" >
<strong>
             ...
             <input name="button2" type="button" id="button2" class="btn btn-default" onClick="MM_goToURL('parent','customers_rent_system.php');return document.MM_returnValue" value="顯示所有資料">
	   ...
	   <div class="container-fluid">
            <ul class="nav nav-tabs">
			  ...
			  <li  class="active"><a href="customers_rent_system.php">租用客戶資料管理</a></li>
  ...
  <?php $i=1; do {  $auto_id=$row_RecMember['no'];?>
	  ...
	  <tr class="td_row" style="background-color:#CCEEFF">
			...
			<td data-th="功能" colspan="2">
				<input type="button" value="修改" class="btn btn-default" onclick="window.open('customers_rent_system_edit.php?nid=<?PHP echo $auto_id;?>', 'newwindow', 'height=450, width=550, top=50, left=200, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no');">
				<input type="button" value="購買" class="btn btn-success" onclick="if(confirm('客戶是否要購買?'))location.href='customers_rent_system.php?upid=<?php echo $auto_id;?>&c_id=<?php echo $row_RecMember['c_id'];?>';">
				<input type="button" value="不使用" class="btn btn-danger" onclick="if(confirm('客戶是否不使用系統?'))location.href='customers_rent_system.php?upid2=<?php echo $auto_id;?>&c_id=<?php echo $row_RecMember['c_id'];?>';">
				<!--<input type="button" value="刪除" class="btn btn-default" onclick="if(confirm('確定要刪除這一筆資料?'))location.href='customers_rent_system.php?deliid=<?php echo $auto_id;?>';">-->
			</td>
        </tr>
