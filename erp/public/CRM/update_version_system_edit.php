...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM update_version WHERE no=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $updateSQL = sprintf("update update_version set `c_id`=%s, `pro_permit_update`=%s, `pro_permit_version`=%s, `program_version`=%s, `updateEDI`=%s, `updateEDI_date`=%s, `newEDI`=%s, `ocean`=%s, `air`=%s, `DES`=%s, `DAS`=%s, `DAS_insdate`=%s, `DAS_ver`=%s, `DGL_insdate`=%s, `DGL_ver`=%s, `D33_edit`=%s, `place`=%s where no=%s",
          ...
          <div class="panel-body">
                 ...
                 <select name="c_id" id="c_id" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit"> 
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["pro_permit_update"],0,3);
											$mm=substr($result["pro_permit_update"],3,2);
											$dd=substr($result["pro_permit_update"],5,2);
										?>
				 ...
				 <select name="dd1" id="dd1" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					?>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["pro_permit_version"],0,3);
											$mm=substr($result["pro_permit_version"],3,2);
											$dd=substr($result["pro_permit_version"],5,2);
										?>
				 ...
				 <select name="dd2" id="dd2" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					?>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["program_version"],0,3);
											$mm=substr($result["program_version"],3,2);
											$dd=substr($result["program_version"],5,2);
										?>
                 ...
                 <input name="updateEDI" type="checkbox" id="updateEDI" value="1" <?php if($result["updateEDI"]==1)echo "checked"; ?>></span><br>
										 </div>
                                    </div>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["updateEDI_date"],0,3);
											$mm=substr($result["updateEDI_date"],3,2);
											$dd=substr($result["updateEDI_date"],5,2);
										?>
				 ...
				 <select name="dd4" id="dd4" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					?>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["newEDI"],0,3);
											$mm=substr($result["newEDI"],3,2);
											$dd=substr($result["newEDI"],5,2);
										?>
                 ...
                 <input name="ocean" type="checkbox" id="ocean" value="1" <?php if($result["ocean"]=="1") 	echo "checked"; ?>>
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="air" type="checkbox" id="air" value="1" <?php if($result["air"]=="1") echo "checked"; ?>>
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="DES" type="checkbox" id="DES" value="1" <?php if($result["DES"]==1)echo "checked"; ?>>
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="DAS" type="checkbox" id="DAS" value="1" <?php if($result["DAS"]==1)echo "checked"; ?>>
                 </span><br> 
										 </div>
                                    </div>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["DAS_insdate"],0,3);
											$mm=substr($result["DAS_insdate"],3,2);
											$dd=substr($result["DAS_insdate"],5,2);
										?>
				 ...
				 <select name="dd6" id="dd6" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					?>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["DAS_ver"],0,3);
											$mm=substr($result["DAS_ver"],3,2);
											$dd=substr($result["DAS_ver"],5,2);
										?>
				 ...
				 <select name="dd7" id="dd7" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					?>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["DGL_insdate"],0,3);
											$mm=substr($result["DGL_insdate"],3,2);
											$dd=substr($result["DGL_insdate"],5,2);
										?>
				 ...
				 <select name="dd8" id="dd8" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					?>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["DGL_ver"],0,3);
											$mm=substr($result["DGL_ver"],3,2);
											$dd=substr($result["DGL_ver"],5,2);
										?>
				 ...
				 <select name="dd9" id="dd9" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					?>
									...
									<div class="form-group">
										 ...
										 <?php
											$yyy=substr($result["D33_edit"],0,3);
											$mm=substr($result["D33_edit"],3,2);
											$dd=substr($result["D33_edit"],5,2);
										?>
				 ...
				 <select name="dd10" id="dd10" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					<?php
						$m=1;
						while($m<=31){
							if($dd)$selected="selected";else $selected="";
							echo "<option value=$m $selected=>$m</option>";
							$m++;
						}
					?>
                 ...
                 <select name="place" id="place" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					<option value="k" <?php  if($result["place"]=="k") echo "selected"; ?>>高雄</option>
					<option value="n" <?php  if($result["place"]=="n") echo "selected"; ?>>台南</option>
				 </select>
                 </span><br>
										 </div>
                                    </div>
