...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("insert into school (`school_name`, `school_contact`, `contact_tel`, `contact_email`, `VTA`, `school_addr`, `inst_date`, `acceptance_date`, `buy_date`, `contract`, `buy_amount`, `classroom`, `maintain_start`, `maintain_end`, `soft_name`, `remark`) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
...
<script>
function dataCheck(){
	if(document.form1.school_name.value==""){
		alert("請輸入學校");
	...
	/*
		...
		?>
				if(document.form1.yyy<?php echo $i;?>.value==""){alert("請選擇<?php echo $name;?>年份");document.form1.yyy<?php echo $i;?>.focus();return false;}
				if(document.form1.mm<?php echo $i;?>.value==""){alert("請選擇<?php echo $name;?>月份");document.form1.mm<?php echo $i;?>.focus();return false;}
				if(document.form1.dd<?php echo $i;?>.value==""){alert("請選擇<?php echo $name;?>日期");document.form1.dd<?php echo $i;?>.focus();return false;}
...
<div id="wrapper">
 ...
 <h3>新增廠商資料</h3>
          ...
          <div class="panel-body">
                 ...
                 <input name="school_contact" type="text" class="form-control" id="school_contact" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="contact_tel" type="text" class="form-control" id="contact_tel" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="VTA" type="text" class="form-control" id="VAT" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="school_addr" type="text" class="form-control" id="school_addr" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="contract" type="text" class="form-control" id="contract" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="buy_amount" type="text" class="form-control" id="buy_amount" >
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="classroom" type="text" class="form-control" id="classroom" >
                 </span><br>
										 </div>
                                    </div>
				 ...
				 <select name="dd4" id="dd4" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					?>
				 </select> 至 <?php $j=date("Y")-1911;$i=$j;$j=$j-3; ?>
                 ...
                 <input name="soft_name" type="text" class="form-control" id="soft_name" >
                 </span><br>
										 </div>
                                    </div>
