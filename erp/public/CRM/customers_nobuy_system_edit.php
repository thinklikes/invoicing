...
<div id="wrapper">
 ...
 <h3>修改廠商租用資料</h3>
          ...
          <div class="panel-body">
                 ...
                 <input name="net" type="text" class="form-control" id="net" value="<?php echo $result["net"]; ?>">
                 </span><br>
										 </div>
                                    </div>
