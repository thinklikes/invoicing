...
*/
  $updateSQL = sprintf("insert into cust_maintain (`c_id`, `soft_end_date`, `contract_amount`, `actual_amount`, `newcust_end`, `hardware_end_date`, `year`, `cost`, `send_contract`, `contract`, `invoice`, `charge`, `remark`) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
  ...
  $Result1 = mysqli_query($connSQL,$updateSQL) or die("新增資料錯誤".mysqli_error());
...
<div id="wrapper">
 ...
 <h3>新增維護廠商資料</h3>
          ...
          <div class="panel-body">
                 ...
                 <input name="newcust_end" type="text" class="form-control" id="newcust_end" >
                 </span><br>
										 </div>
                                    </div>
