...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM donation_db WHERE donation_id=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("update donation_db set donation_year=%s,donation_name=%s,donation_item=%s,donation_name2=%s,donation_money=%s,donation_address=%s,donation_remark=%s,handled=%s where donation_id=%s",
                       GetSQLValueString($_POST['donation_year'], "text"),
                       GetSQLValueString($_POST['donation_name'], "text"),
                       GetSQLValueString($_POST['donation_item'], "text"),
                       GetSQLValueString($_POST['donation_name2'], "text"),
                       GetSQLValueString($_POST['donation_money'], "date"),
                       GetSQLValueString($_POST['donation_address'], "text"),
					   GetSQLValueString($_POST['donation_remark'], "text"),
					   GetSQLValueString($_POST['handled'], "text"),
          ...
          <div class="panel-body">
                      ...
                      <form class="form-horizontal" role="form" action="<?php echo $editFormAction; ?>" METHOD="POST" name="form1" id="form1">
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">捐獻編號</label>
                                         <div class="col-sm-10"><span id="sprytextfield1">
                 <input name="donation_id2" type="text" class="form-control" id="donation_id2" value="<?php  echo $result["donation_id2"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="donation_year" type="text" class="form-control" id="donation_year" value="<?php  echo $result["donation_year"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="donation_name" type="text" class="form-control" id="donation_name" value="<?php  echo $result["donation_name"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="donation_address" type="text" class="form-control" id="donation_address" value="<?php  echo $result["donation_address"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">緣首</label>
                                         <div class="col-sm-10"><span id="sprytextfield4">
                 <input name="donation_name2" type="text" class="form-control" id="donation_name2" value="<?php  echo $result["donation_name2"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">品項</label>
                                         <div class="col-sm-10"><span id="sprytextfield5">
                 <input name="donation_item" type="text" class="form-control" id="donation_item" value="<?php  echo $result["donation_item"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="donation_money" type="text" class="form-control" id="donation_money" value="<?php  echo $result["donation_money"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">經手人</label>
                                         <div class="col-sm-10"><span id="sprytextfield8">
                 <input name="handled" type="text" class="form-control" id="handled" value="<?php  echo $result["handled"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="donation_remark" type="text" class="form-control" id="donation_remark" value="<?php  echo $result["donation_remark"]; ?>">
                 </span><br>
										 </div>
                                    </div>
