        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <!--div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="profile.html"><i class="fa fa-file-text"></i> 資料管理</a>
                    </li>
                    <li>
                         ...
                         <div class="col-lg-12">
                           ...
                           <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">申請加入會員</h3>
                                </div>
                            <div class="panel-body"><p>恭禧您！您已經成功的加入會員！</p>
                <p>您可以利用剛才所設定的帳號、密碼登入系統。</p></div>
                           </div>
                          
                       <input name="button" type="button" onclick="window.location='index.php'" class="btn btn-default" value="回登入頁面">
