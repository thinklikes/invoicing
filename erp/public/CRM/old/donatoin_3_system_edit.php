...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM donation_3_db WHERE donation_id=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("update donation_3_db set donation_year=%s,donation_name=%s,donation_item=%s,donation_money=%s,donation_address=%s,donation_remark=%s,handled=%s where donation_id=%s",
