...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM borrow_db WHERE borrow_id=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("update borrow_db set borrow_date=%s,borrow_name=%s,borrow_identity=%s,borrow_phone=%s,borrow_address=%s,borrow_request=%s,borrow_out=%s,borrow_back=%s,back_date=%s,borrow_remark=%s,borrow_barcode=%s where borrow_id=%s",
                       GetSQLValueString($_POST['borrow_date'], "text"),
                       GetSQLValueString($_POST['borrow_name'], "text"),
                       GetSQLValueString($_POST['borrow_identity'], "text"),
                       GetSQLValueString($_POST['borrow_phone'], "text"),
                       GetSQLValueString($_POST['borrow_address'], "date"),
                       GetSQLValueString($_POST['borrow_request'], "text"),
					   GetSQLValueString($_POST['borrow_out'], "text"),
					   GetSQLValueString($_POST['borrow_back'], "text"),
					   GetSQLValueString($_POST['back_date'], "text"),
					   GetSQLValueString($_POST['borrow_remark'], "text"),
					   GetSQLValueString($_POST['borrow_barcode'], "text"),
...
<div id="wrapper">
 ...
 <h3>修改</h3>
          ...
          <div class="panel-body">
                 ...
                 <input name="borrow_barcode" type="text" class="form-control" id="borrow_barcode" value="<?php  echo $result["borrow_barcode"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_date" type="text" class="form-control" id="borrow_date" value="<?php  echo $result["borrow_date"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_name" type="text" class="form-control" id="borrow_name" value="<?php  echo $result["borrow_name"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_identity" type="text" class="form-control" id="borrow_identity" value="<?php  echo $result["borrow_identity"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_phone" type="text" class="form-control" id="borrow_phone" value="<?php  echo $result["borrow_phone"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_address" type="text" class="form-control" id="borrow_address" value="<?php  echo $result["borrow_address"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">求金金額</label>
                                         <div class="col-sm-10"><span id="sprytextfield8">
                 <input name="borrow_request" type="text" class="form-control" id="borrow_request" value="<?php  echo $result["borrow_request"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">借出金額</label>
                                         <div class="col-sm-10"><span id="sprytextfield8">
                 <input name="borrow_out" type="text" class="form-control" id="borrow_out" value="<?php  echo $result["borrow_out"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">還金金額</label>
                                         <div class="col-sm-10"><span id="sprytextfield8">
                 <input name="borrow_back" type="text" class="form-control" id="borrow_back" value="<?php  echo $result["borrow_back"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">還金日期</label>
                                         <div class="col-sm-10"><span id="sprytextfield8">
                 <input name="back_date" type="text" class="form-control" id="back_date" value="<?php  echo $result["back_date"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <textarea name="borrow_remark" class="form-control" id="borrow_remark" value=""><?php  echo $result["borrow_remark"]; ?></textarea>
                 </span><br>
										 </div>
                                    </div>
