...
// *** Redirect if username exists
	if (isset($_GET["nid"])) {
	  ...
	  $LoginRS__query = sprintf("SELECT donation_id,donation_year,donation_name,donation_money,donation_address,donation_remark,handled,donation_id2 FROM donation_3_db WHERE donation_id=%s", GetSQLValueString($donation_id, "text"));
	  //echo $LoginRS__query;
	...
	{
		echo "<script>location.href='donation_3_system.php';</script>";
	}
