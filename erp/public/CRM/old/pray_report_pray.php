...
?>
	...
	<tr>
			...
			<td data-th="地址" class="a_01" ><?php echo $row_RecMember["pray_address"];?></td>	
			<td data-th="年份" class="a_01"><?php echo $row_RecMember["fd_pray_year"];?></td>
			<td data-th="日期" class="a_01"><?php echo $row_RecMember["fd_pray_dateone"];?></td>
			<td data-th="收款日" class="a_01"><?php echo $row_RecMember["fd_pray_datetwo"];?></td>
			<td data-th="金額" class="a_01"><?php echo $row_RecMember["fd_pray_receivables"];?></td>			
