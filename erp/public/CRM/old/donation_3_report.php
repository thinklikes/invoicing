...
/*	$rs2 =  mysqli_query($connSQL,"select * from donation_db WHERE $search like '$keyword%'");	
	...
	*/
//==============計算總數END
$query_RecMember= "select * from donation_3_db WHERE $search like '$keyword' ORDER BY donation_id desc ";
//echo $query_RecMember;exit;
...
?>
	...
	<tr>
			<td data-th="捐獻編號" class="a_01"><?php echo $row_RecMember["donation_id2"];?></td>
			<td data-th="年份" class="a_01"><?php echo $row_RecMember["donation_year"];?></td>
			<td data-th="姓名" class="a_01"><?php echo $row_RecMember["donation_name"];?></td>
			<td data-th="地址" class="a_01"><?php echo $row_RecMember["donation_address"];?></td>
			<td data-th="緣首" class="a_01"><?php echo $row_RecMember["donation_name2"];?></td>
			<td data-th="品項" class="a_01"><?php echo $row_RecMember["donation_item"];?></td>
			<td data-th="捐獻金額" class="a_01" ><?php echo $row_RecMember["donation_money"];?></td>	
			<td data-th="經手人" class="a_01"><?php echo $row_RecMember["handled"];?></td>
			<td data-th="備註" class="a_01"><?php echo $row_RecMember["donation_remark"];?></td>			
	</tr>
	<!--<tr align="center"  style="background-color: #159;color: #fff;" >
