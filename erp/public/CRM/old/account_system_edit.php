...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM account_db WHERE account_id=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("update account_db set account_year=%s,account_subject=%s,account_abstract=%s,account_address=%s,account_income=%s,account_expenses=%s,account_surplus=%s,account_remark=%s where account_id=%s",
