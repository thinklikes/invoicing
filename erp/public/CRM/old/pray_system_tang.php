...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("update pray set tang_year=%s,tang_money=%s where auto_id=%s",
                       GetSQLValueString($_POST['tang_year'], "text"),
                       GetSQLValueString($_POST['tang_money'], "text"),
          ...
          <div class="panel-body">
                      ...
                      <form class="form-horizontal" role="form" action="<?php echo $editFormAction; ?>" METHOD="POST" name="form1" id="form1">
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">堂份年份 例:103</label>
                                         <div class="col-sm-10"><span id="sprytextfield1">
                 <input name="tang_year" type="text" class="form-control" id="tang_year" value="<?php  echo $result["tang_year"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">堂份金額</label>
                                         <div class="col-sm-10"><span id="sprytextfield2">
                 <input name="tang_money" type="text" class="form-control" id="tang_money" value="<?php  echo $result["tang_money"]; ?>">
                 </span><br>
										 </div>
                                    </div>
