...
if($_SESSION['MM_Username']!=""){
    ...
    //setcookie("remuser", '', time()); //去除使用者名稱的 Cookie 值
    header("Location:pray_system.php");
    exit;
}
...
if (isset($_POST['ad_account'])) {
  ...
  $MM_redirectLoginSuccess = "pray_system.php";
  $MM_redirectLoginFailed = "login.php";
  $MM_redirecttoReferrer = false;
  //mysql_select_db($database_connSQL, $connSQL);
  $_SESSION['MM_Username'] = $loginUsername;
	
  $LoginRS__query=sprintf("SELECT ad_account, ad_pw FROM admin_tb WHERE ad_account=%s AND ad_pw=%s",
...
<body>
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">會員管理系統</a>
            </div>
         </nav>
  <div class="container">
               <div class="row">
     ...
     <div class="panel-body">
                                   <form class="form-horizontal" role="form" ACTION="<?php echo $loginFormAction; ?>" name="form1" method="POST">
									...
									<div class="form-group">
                                         ...
                                         <div class="col-sm-10">
                                             <input type="password" name="ad_pw" class="form-control" id="ad_pw" placeholder="請輸入密碼" alue="<?php if(isset($_COOKIE['rempass'])) echo $_COOKIE['rempass']; //密碼 ?>">
                                         </div>
                                    </div>
									<div class="form-group">
