...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM borrow_db WHERE borrow_db_id=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("insert into borrow_db (borrow_barcode,borrow_date,borrow_name,borrow_identity,borrow_phone,borrow_address,borrow_request,borrow_out,borrow_back,back_date,borrow_remark)  value (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                       ...
                       GetSQLValueString($_POST['borrow_phone'], "date"),
                       GetSQLValueString($_POST['borrow_address'], "text"),
					   GetSQLValueString($_POST['borrow_request'], "text"),
					   GetSQLValueString($_POST['borrow_out'], "text"),
					   GetSQLValueString($_POST['borrow_back'], "int"),
...
<div id="wrapper">
 ...
 <h3>新增帳冊資料</h3>
          ...
          <div class="panel-body">
                 ...
                 <input name="borrow_barcode" type="text" class="form-control" id="borrow_barcode" value="">
                 </span><br>
										 </div>
                                    </div>
									...
									<div class="form-group">
                                         ...
                                         <div class="col-sm-10"><span id="sprytextfield1">
                 <input name="borrow_date" type="text" class="form-control" id="borrow_date" value="">例:1030101
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_name" type="text" class="form-control" id="borrow_name" value="">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_identity" type="text" class="form-control" id="borrow_identity" value="">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_phone" type="text" class="form-control" id="borrow_phone" value="">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_address" type="text" class="form-control" id="borrow_address" value="">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="borrow_request" type="text" class="form-control" id="borrow_request" value="">
                 </span>
										 </div>
                                    </div>
									...
									<div class="form-group">
                                         ...
                                         <div class="col-sm-10"><span id="sprytextfield7">
                 <input name="borrow_out" type="text" class="form-control" id="borrow_out" value="">
                 </span>
										 </div>
                                    </div>
									...
									<div class="form-group">
                                         ...
                                         <div class="col-sm-10"><span id="sprytextfield7">
                 <input name="borrow_back" type="text" class="form-control" id="borrow_back" value="">
                 </span>
										 </div>
                                    </div>
									...
									<div class="form-group">
                                         ...
                                         <div class="col-sm-10"><span id="sprytextfield7">
                 <input name="back_date" type="text" class="form-control" id="back_date" value="">
                 </span>
										 </div>
                                    </div>
                 ...
                 <textarea name="borrow_remark" id="borrow_remark" class="form-control"></textarea>
                 </span>
										 </div>
                                    </div>
