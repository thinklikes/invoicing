...
/*	$rs2 =  mysqli_query($connSQL,"select * from donation_db WHERE $search like '$keyword%'");	
	...
	*/
//==============計算總數END
$query_RecMember= "select * from account_db2 WHERE $search like '$keyword' ORDER BY account_id desc ";
...
//餘額--計算總數
	$rs2 =  mysqli_query($connSQL,"SELECT SUM(account_surplus) as account_surplus,SUM(account_expenses) as account_expenses,SUM(account_income) as account_income  FROM account_db2 WHERE $search like '$keyword' ");	
