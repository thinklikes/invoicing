...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM account_db2 WHERE account_id=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("update account_db2 set account_year=%s,account_subject=%s,account_abstract=%s,account_address=%s,account_income=%s,account_expenses=%s,account_surplus=%s,account_remark=%s where account_id=%s",
...
<div id="wrapper">
 ...
 <h3>修改</h3>
          ...
          <div class="panel-body">
                 ...
                 <input name="account_year" type="text" class="form-control" id="account_year" value="<?php  echo $result["account_year"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="account_subject" type="text" class="form-control" id="account_subject" value="<?php  echo $result["account_subject"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="account_abstract" type="text" class="form-control" id="account_abstract" value="<?php  echo $result["account_abstract"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="account_address" type="text" class="form-control" id="account_address" value="<?php  echo $result["account_address"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="account_income" type="text" class="form-control" id="account_income" value="<?php  echo $result["account_income"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="account_expenses" type="text" class="form-control" id="account_expenses" value="<?php  echo $result["account_expenses"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="account_surplus" type="text" class="form-control" id="account_surplus" value="<?php  echo $result["account_surplus"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <textarea name="account_remark" class="form-control" id="account_remark" value=""><?php  echo $result["account_remark"]; ?></textarea>
                 </span><br>
										 </div>
                                    </div>
