...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("update pray set fd_pray_year=%s,fd_pray_dateone=%s,fd_pray_datetwo=%s,fd_pray_receivables=%s where auto_id=%s",
                       GetSQLValueString($_POST['fd_pray_year'], "text"),
                       GetSQLValueString($_POST['fd_pray_dateone'], "text"),
                       GetSQLValueString($_POST['fd_pray_datetwo'], "text"),
                       GetSQLValueString($_POST['fd_pray_receivables'], "text"),
...
<div id="wrapper">
 ...
 <h3>祈福資料</h3>
          ...
          <div class="panel-body">
                      ...
                      <form class="form-horizontal" role="form" action="<?php echo $editFormAction; ?>" METHOD="POST" name="form1" id="form1">
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">祈福年份 例:103</label>
                                         <div class="col-sm-10"><span id="sprytextfield1">
                 <input name="fd_pray_year" type="text" class="form-control" id="fd_pray_year" value="<?php  echo $result["fd_pray_year"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">祈福日期 例:1030101</label>
                                         <div class="col-sm-10"><span id="sprytextfield2">
                 <input name="fd_pray_dateone" type="text" class="form-control" id="fd_pray_dateone" value="<?php  echo $result["fd_pray_dateone"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">祈福收款日 例:1030101</label>
                                         <div class="col-sm-10"><span id="sprytextfield3">
                 <input name="fd_pray_datetwo" type="text" class="form-control" id="fd_pray_datetwo" value="<?php  echo $result["fd_pray_datetwo"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">祈福金額</label>
                                         <div class="col-sm-10"><span id="sprytextfield4">
                 <input name="fd_pray_receivables" type="text" class="form-control" id="fd_pray_receivables" value="<?php  echo $result["fd_pray_receivables"]; ?>">
                 </span><br>
										 </div>
                                    </div>
      ...
      <div class="col-sm-offset-2 col-sm-10">
         ...
         <button type="submit" class="btn btn-default" name="Submit2">確定</button>
