...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM account_db3 WHERE donation_id=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("insert  into account_db3 (account_year,account_subject,account_abstract,account_address,account_income,account_expenses,account_surplus,account_remark)  value (%s,%s,%s,%s,%s,%s,%s,%s)",
