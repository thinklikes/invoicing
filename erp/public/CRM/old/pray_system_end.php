...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("update pray set fd_end_year=%s,fd_end_dateone=%s,fd_end_datetwo=%s,fd_end_receivables=%s where auto_id=%s",
                       GetSQLValueString($_POST['fd_end_year'], "text"),
                       GetSQLValueString($_POST['fd_end_dateone'], "text"),
                       GetSQLValueString($_POST['fd_end_datetwo'], "text"),
                       GetSQLValueString($_POST['fd_end_receivables'], "text"),
          ...
          <div class="panel-body">
                      ...
                      <form class="form-horizontal" role="form" action="<?php echo $editFormAction; ?>" METHOD="POST" name="form1" id="form1">
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">完福年份 例:103</label>
                                         <div class="col-sm-10"><span id="sprytextfield1">
                 <input name="fd_end_year" type="text" class="form-control" id="fd_end_year" value="<?php  echo $result["fd_end_year"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">完福日期 例:1030101</label>
                 ...
                 <input name="fd_pray_dateone" type="text" class="form-control" id="fd_pray_dateone" value="<?php  echo $result["fd_pray_dateone"]; ?>">
									...
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">完福收款日 例:1030101</label>
                                         <div class="col-sm-10"><span id="sprytextfield3">
                 <input name="fd_end_datetwo" type="text" class="form-control" id="fd_end_datetwo" value="<?php  echo $result["fd_end_datetwo"]; ?>">
                 </span><br>
										 </div>
                                    </div>
									
									<div class="form-group">
                                         <label  class="col-sm-2 control-label">完福金額</label>
                                         <div class="col-sm-10"><span id="sprytextfield4">
                 <input name="fd_end_receivables" type="text" class="form-control" id="fd_end_receivables" value="<?php  echo $result["fd_end_receivables"]; ?>">
                 </span><br>
										 </div>
                                    </div>
