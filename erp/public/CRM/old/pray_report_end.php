...
?>
	...
	<tr>
			...
			<td data-th="日期" class="a_01"><?php echo $row_RecMember["fd_end_dateone"];?></td>
			<td data-th="收款日" class="a_01"><?php echo $row_RecMember["fd_end_datetwo"];?></td>
			<td data-th="金額" class="a_01"><?php echo $row_RecMember["fd_end_receivables"];?></td>			
