...
/*	$rs2 =  mysqli_query($connSQL,"select * from donation_db WHERE $search like '$keyword%'");	
	...
	*/
//==============計算總數END
$query_RecMember= "select * from borrow_db WHERE $search like '$keyword' and borrow_back!='0' ORDER BY borrow_id desc ";
...
?>
	...
	<tr>
			<td data-th="編號" class="a_01"><?php echo $row_RecMember["borrow_barcode"];?></td>
			<td data-th="年份" class="a_01"><?php echo $row_RecMember["borrow_date"];?></td>
			<td data-th="姓名" class="a_01"><?php echo $row_RecMember["borrow_name"];?></td>
			<td data-th="身分證字號" class="a_01"><?php echo $row_RecMember["borrow_identity"];?></td>
			<td data-th="電話" class="a_01"><?php echo $row_RecMember["borrow_phone"];?></td>
			<td data-th="地址" class="a_01"><?php echo $row_RecMember["borrow_address"];?></td>
			<td data-th="求金金額" class="a_01"><?php echo $row_RecMember["borrow_request"];?></td>
			<td data-th="借出金額" class="a_01" ><?php echo $row_RecMember["borrow_out"];?></td>
			<td data-th="還金金額" class="a_01" ><?php echo $row_RecMember["borrow_back"];?></td>
			<td data-th="還金日期" class="a_01"><?php echo $row_RecMember["back_date"];?></td>
			<td data-th="備註" class="a_01"><?php echo $row_RecMember["borrow_remark"];?></td>			
	</tr>
	<!--<tr align="center"  style="background-color: #159;color: #fff;" >
