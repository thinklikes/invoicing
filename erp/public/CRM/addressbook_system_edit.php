...
if (isset($_GET["nid"])) {
  $auto_id=$_GET["nid"];
  $LoginRS__query = sprintf("SELECT * FROM addressbook WHERE no=%s", GetSQLValueString($auto_id, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $updateSQL = sprintf("update addressbook set `name`=%s, `tel_1`=%s, `tel_2`=%s, `phone`=%s, `fax`=%s, `remark`=%s, `status`=%s where no=%s",
...
<div id="wrapper">
 ...
 <h3>新增通訊錄</h3>
          ...
          <div class="panel-body">
                 ...
                 <input name="tel_1" type="text" class="form-control" id="tel_1" value="<?php echo $result["tel_1"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="tel_2" type="text" class="form-control" id="tel_2" value="<?php echo $result["tel_2"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <input name="fax" type="text" class="form-control" id="fax" value="<?php echo $result["fax"]; ?>">
                 </span><br>
										 </div>
                                    </div>
                 ...
                 <select name="status" id="status" class="selectpicker" data-show-subtext="true" data-live-search="true" data-width="fit">
					...
					<option value="1" <?php if($result["status"]==1)echo "selected"; ?>>傑瑀</option>
					<option value="2" <?php if($result["status"]==2)echo "selected"; ?>>高雄大容</option>
					<option value="3" <?php if($result["status"]==3)echo "selected"; ?>>台北大容</option>
					<option value="4" <?php if($result["status"]==4)echo "selected"; ?>>台中大容</option>
					<option value="5" <?php if($result["status"]==5)echo "selected"; ?>>國群</option>
					<option value="6" <?php if($result["status"]==6)echo "selected"; ?>>國貿局</option>
					<option value="7" <?php if($result["status"]==7)echo "selected"; ?>>網路公司</option>
					<option value="8" <?php if($result["status"]==8)echo "selected"; ?>>公會</option>
					<option value="9" <?php if($result["status"]==9)echo "selected"; ?>>檢驗局</option>
				 </select>
                 </span><br>
										 </div>
                                    </div>
