...
@section('content')
        ...
        <form action="{{ url("/supplier") }}" method="POST">
            ...
            <table width="100%" class="table">
                ...
                <tr>
                    <th>匯款戶名</th>
                    <td><input type="text" name="supplier[remName]" id="remName" value="{{ $supplier['remName'] }}"></td>
                </tr>
                <tr>
                    <th>匯款局號</th>
                    <td><input type="text" name="supplier[remBureau]" id="remBureau" value="{{ $supplier['remBureau'] }}"></td>
                </tr>
                <tr>
                    <th>匯款帳號</th>
                    <td><input type="text" name="supplier[remAccount]" id="remAccount" value="{{ $supplier['remAccount'] }}"></td>
                </tr>
            </table>
