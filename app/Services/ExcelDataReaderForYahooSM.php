...
class ExcelDataReaderForYahooSM implements B2CExcelDataReader
{
    private $platform = 'YAHOO超商';
...
//        }
        ...
        $returnData['saleOrderMaster']['delivery_method'] = '超商';
//        try {
//            // 設定配送方式不是超商就是宅配
