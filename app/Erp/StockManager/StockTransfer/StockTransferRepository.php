...
use StockTransfer\StockTransferMaster as OrderMaster;
use StockTransfer\StockTransferDetail as OrderDetail;
use DB;

class StockTransferRepository extends BasicRepository
{
     ...
     *
     * @param StockTransferMaster $puchase_order_master
     */
