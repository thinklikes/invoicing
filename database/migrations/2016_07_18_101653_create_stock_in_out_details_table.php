...
class CreateStockInOutDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('erp_stock_in_out_detail', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('erp_stock_in_out_detail');
    }
}
