...
class ChangeFieldNameToPage extends Migration
{
    ...
    public function up()
    {
        ...
        $pages = [
            ['code' => '/1'      , 'name' => '首頁', 'level' => -1, 'route_name' => 'portal', 'enabled' => 1],
            ['code' => '/1/2'  , 'name' => '倉庫資料管理', 'level' => 2, 'route_name' => 'warehouse-index', 'enabled' => 1],
            ['code' => '/1/2/3', 'name' => '新增單筆倉庫資料', 'level' => 3, 'route_name' => 'warehouse-create', 'enabled' => 1],
            ['code' => '/1/2/4', 'name' => '存入單筆倉庫資料', 'level' => 3, 'route_name' => 'warehouse-store', 'enabled' => 1],
            ['code' => '/1/2/5', 'name' => '檢視單筆倉庫資料', 'level' => 3, 'route_name' => 'warehouse-show', 'enabled' => 1],
            ['code' => '/1/2/6', 'name' => '維護單筆倉庫資料', 'level' => 3, 'route_name' => 'warehouse-edit', 'enabled' => 1],
            ['code' => '/1/2/7', 'name' => '更新單筆倉庫資料', 'level' => 3, 'route_name' => 'warehouse-update', 'enabled' => 1],
            ['code' => '/1/2/8', 'name' => '刪除單筆倉庫資料', 'level' => 3, 'route_name' => 'warehouse-destroy', 'enabled' => 1],
